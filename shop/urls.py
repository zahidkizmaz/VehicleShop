...
from shop.views import CategoryView , HomePageView, FirmView, RegistrationView, BrandView, CreateVehicleView, CreateBrandView, VehicleView, DeleteVehicleView, UpdateVehicleView
